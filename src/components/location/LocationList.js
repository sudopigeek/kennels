...
import { getAllLocations, closeLocation } from '../../modules/LocationManager';
...
export const LocationList = () => {
    ...
    return (
        <div className="container-cards">
            {locations.map(location => <LocationCard key={location.id} location={location} handleCloseLocation={handleCloseLocation} />)}
        </div>
    );
};